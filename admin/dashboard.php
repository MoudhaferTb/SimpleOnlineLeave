...
<body>
	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
					<a href="salary_management.php" class="btn btn-primary btn-block" style="border-radius:0%;"><i class="fa fa-money"></i> Salary</a>
				</div>
				<div class="col-md"></div>
			</div>
		</div>
	...
	<section id="main-footer" class="text-center text-white bg-inverse mt-4 p-4">
		<div class="container">
			<div class="row">
				<div class="col">
				<p class="lead">&copy; <?php echo date("Y")?> CPG</p>
				</div>
			</div>
		</div>
	</section>
